...
class AlternatifDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($row){
            ...
            $action .= '<form method="post" action="' . route("alternatif.destroy", Crypt::encrypt($row->id)) . '"
                id="deleteAlternatif" style="display:inline" data-bs-toggle="tooltip"
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('nama')->title('Kriteria'),
