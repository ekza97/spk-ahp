...
@can('read permission')
        ...
        <div class="page-heading">
            ...
            <section class="section row">
                <div class="col-md-4">
                    ...
                    <div class="card">
                        <form action="" method="post" id="saveMasterDokumen">
                            @csrf
    ...
    @push('scriptjs')
        <script>
            ...
            function editData(id) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#saveMasterDokumen").attr('action', response.link);
            ...
            $('#saveMasterDokumen').on('submit', function(e) {
                e.preventDefault();
                let spin =
                ...
                var link = $("#saveMasterDokumen").attr('action');
                let type = "PUT";
                if (link == "") {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $("#saveMasterDokumen").attr('action', '');
                        $("#btnSave").html('<i class="bi bi-save"></i> Simpan').removeAttr('disabled');
                        //delete field
                        $('[name="name"]').val('');
                        $('[name="description"]').val('');
                        // window.scrollTo(0, document.body.scrollHeight);
                        $('#masterdokumen-table').DataTable().ajax.reload(null, false);
                        $('[name="name"]').focus();
            ...
            $(document).on('click', '#deleteMasterDokumen', function(e) {
                e.preventDefault();
