<div class="modal fade" id="formEditModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="saveExamEdit" action="" method="post">
                @csrf
                @method('PUT')
                <div class="modal-header">
                    <h4 class="modal-title mt-n3">Edit Ujian</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="row p-1">
                        <div class="form-group col-12 mb-3">
                            ...
                            <input type="text" name="name" id="name_edit" class="form-control" autofocus required>
                        </div>
                        <div class="form-group col-12 mb-3">
                        ...
                        <div class="form-group col-6 mb-2">
                            <label for="jml_soal" class="form-group">Jumlah Soal<span
                                    class="text-danger">*</span></label>
                            <input type="text" name="jml_soal" id="jml_soal_edit" class="form-control nisn" required>
                        </div>
                        <div class="form-group col-6 mb-2">
                            <label for="jml_waktu" class="form-group">Waktu Ujian<span
                                    class="text-danger">*</span></label>
                            <div class="input-group mb-3">
                                <input type="text" class="form-control nisn" name="jml_waktu" id="jml_waktu_edit"
                        ...
                        <div class="form-group col-6 mb-2">
                            <label for="exam_start_date" class="form-group">Tanggal Mulai<span
                                    class="text-danger">*</span></label>
                            <input type="date" name="exam_start_date" id="exam_start_date_edit" class="form-control"
                                required>
                        </div>
                        <div class="form-group col-6 mb-2">
                            <label for="exam_start_time" class="form-group">Jam Mulai<span
                                    class="text-danger">*</span></label>
                            <input type="time" name="exam_start_time" id="exam_start_time_edit" class="form-control"
                                required>
                        </div>
                        <div class="form-group col-6 mb-2">
                            <label for="exam_end_date" class="form-group">Tanggal Selesai<span
                                    class="text-danger">*</span></label>
                            <input type="date" name="exam_end_date" id="exam_end_date_edit" class="form-control"
                                required>
                        </div>
                        <div class="form-group col-6 mb-2">
                            <label for="exam_end_time" class="form-group">Jam Selesai<span
                                    class="text-danger">*</span></label>
                            <input type="time" name="exam_end_time" id="exam_end_time_edit" class="form-control"
                                required>
                        </div>
