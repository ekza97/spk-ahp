        ...
        <div class="page-heading">
            ...
            <section class="section row">
                <div class="col-md-4">
                    <!-- Form Course Modal -->
                    <div class="card">
                        <form action="" method="post" id="saveAlternatif">
                            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-1">
                                        <div class="form-group">
                                            <label for="nama" class="form-label">Nama Alternatif<span
                                                    class="text-danger">*</span></label>
    ...
    @push('scriptjs')
        <script>
            ...
            $('#btnCancel').on('click', function() {
                ...
                $('[name="nama"]').val('');
                $('[name="kode"]').focus();
                $("#saveAlternatif").attr('action', '');
                $("#btnSave").html('<i class="bi bi-save"></i> Simpan');
            });

            function editData(id) {
                $('[name="name"]').focus();
                var link = "{{ route('alternatif.edit', ':id') }}";
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#saveAlternatif").attr('action', response.link);
            ...
            $('#saveAlternatif').on('submit', function(e) {
                e.preventDefault();
                let spin =
                ...
                var link = $("#saveAlternatif").attr('action');
                let type = "PUT";
                if (link == "") {
                    link = "{{ route('alternatif.store') }}";
                    type = "POST";
                }
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#alternatif-table').DataTable().ajax.reload(null, false);
                        $('[name="kode"]').focus();
            ...
            $(document).on('click', '#deleteAlternatif', function(e) {
                e.preventDefault();
